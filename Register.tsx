...
function LokestaLogo({ size = 42 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      ...
      <path d="M50 8 C30 8 14 24 14 44 C14 64 50 92 50 92 C50 92 86 64 86 44 C86 24 70 8 50 8Z" fill="url(#pinReg3)"/>
      ...
      <defs>
        <linearGradient id="pinReg3" x1="14" y1="8" x2="86" y2="92" gradientUnits="userSpaceOnUse">
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (form.password.length < 6) { setError("Password iwe na herufi 6 au zaidi"); return; }
    setLoading(true);
    setError("");
    try {
      ...
      if (status === 409 || msg.toLowerCase().includes("exist") || msg.toLowerCase().includes("already")) {
        ...
        setError(msg || "Taarifa si sahihi — angalia na ujaribu tena");
